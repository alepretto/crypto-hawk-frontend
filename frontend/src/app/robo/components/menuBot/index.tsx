...
export function ChartControls({ onSymbolChange, onIntervalChange, onMarketChange, onEnvironmentChange }: ChartControlsProps) {
    ...
    <Card className="border">
      <CardContent className="pt-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select defaultValue="BTCUSDT" onValueChange={onSymbolChange}>
        ...
        <div className="space-y-2">
          ...
          <Select defaultValue="1h" onValueChange={onIntervalChange}>
        ...
        <div className="space-y-2">
          ...
          <Select defaultValue="futures" onValueChange={onMarketChange}>
        ...
        <div className="space-y-2">
          ...
          <Select defaultValue="testnet" onValueChange={onEnvironmentChange}>
